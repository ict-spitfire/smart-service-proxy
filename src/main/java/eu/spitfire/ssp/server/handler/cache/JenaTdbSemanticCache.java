...
//import eu.spitfire.ssp.server.internal.messages.responses.QueryExecutionSuccess;
...
//                resultFuture.set(new ExpiringGraphHttpResponse(HttpResponseStatus.OK, expiringNamedGraph));
//            }
//
//            return resultFuture;
//		}
...
//
//    @Override
//	public ListenableFuture<QueryExecutionSuccess> processSparqlQuery(Query sparqlQuery) {
//
//        SettableFuture<QueryExecutionSuccess> resultFuture = SettableFuture.create();
//		dataset.begin(ReadWrite.READ);
//
//		try {
...
//                QueryExecutionSuccess resultMessage = new QueryExecutionSuccess(resultSet);
