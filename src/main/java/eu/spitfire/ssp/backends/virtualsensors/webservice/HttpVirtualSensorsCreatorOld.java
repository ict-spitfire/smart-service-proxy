...
//    private VirtualSensorRegistry slseRegistry;
//
//
//    public HttpVirtualSensorsCreatorOld(VirtualSensorBackendComponentFactory componentFactory){
...
//        this.slseRegistry = (VirtualSensorRegistry) componentFactory.getRegistry();
//    }
//
//
//    @Override
...
//
//        Futures.addCallback(this.slseRegistry.registerVirtualSensor(dataOrigin), new FutureCallback<Void>() {
//            @Override
