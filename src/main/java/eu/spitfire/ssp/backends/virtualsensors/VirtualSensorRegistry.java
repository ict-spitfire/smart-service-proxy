...
import eu.spitfire.ssp.backends.virtualsensors.webservice.VirtualSensorBatchCreator;
import eu.spitfire.ssp.backends.virtualsensors.webservice.VirtualSensorsCreator;
 ...
 */
public class VirtualSensorRegistry extends Registry<URI> {

    private Logger log = LoggerFactory.getLogger(this.getClass().getName());

    protected VirtualSensorRegistry(BackendComponentFactory<URI> componentFactory) {
    ...
    public void startRegistry() throws Exception {
        ...
        this.registerWebservice(
                new VirtualSensorsCreator((VirtualSensorBackendComponentFactory) this.componentFactory),
