package eu.spitfire.ssp.backends.external.coap_old.registry;//package eu.spitfire.ssp.backends.external.coap.registry;
//
...
//
//
//    public WellKnownCoreProcessor(ExecutorService internalTasksExecutorService){
