...
/**
 * A {@link eu.spitfire.ssp.backend.generic.DataOrigin} is an wrapper for an arbitrary component hosting semantic
 ...
 * this Web Resource.
 *
 * The complete RDF information provided by an instance of {@link eu.spitfire.ssp.backend.generic.DataOrigin} is
...
public abstract class DataOrigin<I> {
    ...
    /**
     * Returns <code>true</code> if this {@link eu.spitfire.ssp.backend.generic.DataOrigin} instance is observable
     * and <code>false</code> otherwise
     * @return <code>true</code> if this {@link eu.spitfire.ssp.backend.generic.DataOrigin} instance is observable
     * and <code>false</code> otherwise
     */
     ...
     * is unique among all {@link eu.spitfire.ssp.backend.generic.DataOrigin}s per local backend.
     *
     ...
     * data that was retrieved by a {@link eu.spitfire.ssp.backend.generic.DataOrigin}, i.e. a graph backendName is unique
     * over all {@link eu.spitfire.ssp.backend.generic.DataOrigin}s "worldwide" and not only locally as the result
     ...
     * {@link eu.spitfire.ssp.backend.generic.DataOrigin} and the {@link java.net.URI}s returned by
     * {@link eu.spitfire.ssp.backend.generic.DataOrigin#getGraphName()} of this and the given instance are equal.
     * *
     * @param object the {@link java.lang.Object} to check this instance of
     * {@link eu.spitfire.ssp.backend.generic.DataOrigin} for equality.
     *
