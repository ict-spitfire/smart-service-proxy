            ...
            if(settings.inline) {
              ...
              if(!promptExists) {
                if(settings.transition && $.fn.transition !== undefined && $module.transition('is supported')) {
                  module.verbose('Displaying error with style transition', settings.transition);
      ...
      module = {
        ...
        animate: {
          ...
          hide: function(callback) {
            ...
            ;
            if(settings.on != 'hover' && settings.useCSS && $.fn.transition !== undefined && $dimmer.transition('is supported')) {
              module.verbose('Hiding dimmer with style');
              $dimmer
                .transition({
      ...
      module  = {
        ...
        showModal: function(callback) {
          ...
          if(module.othersVisible()  && !settings.allowMultiple) {
            ...
            if(settings.transition && $.fn.transition !== undefined && $module.transition('is supported')) {
              module.debug('Showing modal with style animations');
              $module
        ...
        hideModal: function(callback) {
          ...
          if(settings.transition && $.fn.transition !== undefined && $module.transition('is supported')) {
            module.debug('Hiding modal with style animations');
            $module
    ...
    .each(function() {
      ...
      module      = {
        ...
        pullPage: function() {
          ...
          ;
          if(settings.useCSS) {
            module.debug('Resetting body position style');
        ...
        add: {
          bodyCSS: function(direction, distance) {
            ...
            $head.append(style);
            module.debug('Adding body style to head', $style);
          }
        },
        ...
        remove: {
          bodyCSS: function() {
            module.debug('Removing body style styles', $style);
            module.refresh();
            $style.remove();
          },
          active: function() {
        ...
        can: {
          animate: function() {
            if($module.css(settings.animation) !== 'none') {
              ...
              module.debug('Unable to find style definition', $module.attr('class'));
              return false;
            }
          },
          transition: function() {
...
$.fn.transition.settings = {
  ...
  // possible errors
  error: {
    noAnimation : 'There is no style animation matching the one you specified.',
